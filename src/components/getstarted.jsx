...
function GetStarted(){
    return (
        <div class = 'getstarted flex flex-col justify-center items-center text-center h-screen pb-8 select-none '>
            <h1 class='glow lg:text-8xl text-6xl'>MedWallet</h1>
            <h3 class='lg:text-4xl text-2xl text-center pt-8'>Bringing education and transparency to medical billing</h3>

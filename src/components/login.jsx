    ...
    return (
        <div class='h-screen w-full justify-center items-center flex'>
            <div class='bg-black border rounded-2xl border-sky-500 h-5/6 md:w-2/6 sm:w-3/6 w-4/6 shadow-2xl shadow-black flex flex-col text-center items-center'>
                ...
                <button class="registerbtn buttonshadow bg-blue-700 hover:bg-blue-900 hover:text-dimWhite text-white text-lg font-bold py-2 px-4 rounded-lg mt-12 transition duration-500 h-12"  onClick = {() => performRegistration()}>SIGN IN</button>
